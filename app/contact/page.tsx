    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 text-center">
           ...
           <a href="mailto:support@maniparena.org" className="mt-4 inline-block text-green-600 hover:text-green-500 font-medium">
        ...
        <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 text-center">
           ...
           <a href="#" className="mt-4 inline-block text-green-600 hover:text-green-500 font-medium">
             Join Discord
           </a>
        </div>
      ...
      <div className="mt-16 bg-gray-50 rounded-lg overflow-hidden">
        <div className="px-6 py-8 sm:p-10">
           ...
           <form className="mt-8 max-w-xl mx-auto space-y-6">
              ...
              <div>
                  <button type="submit" className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none">
                      Send Message
                  </button>
              </div>
           </form>
